...
type Visit struct {
	...
	Uuid         string `json:"uuid" gorm:"type:varchar(32); not null; default ''; comment:'跟踪id' "`
	...
	FromUrl      string `json:"content" gorm:"type:varchar(2000); not null; default ''; comment:'访问来源' "`
